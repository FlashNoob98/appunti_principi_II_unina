...
%Elimina l'opzione twoside e commenta le successive quattro righe per rimuovere la rilegatura
...
\pdfinfo{%
  /Title    (Appunti Principi di Ingegneria Elettrica II)
  /Author   (Daniele Olivieri)
  /Creator  ()
  /Producer ()
  /Subject  (Principi di Ingegneria Elettrica II)
  /Keywords (Ingegneria, Elettrica, Appunti)
}
...
\include{16_densita_polarizzazione_maxwell_dielettrici}
\include{17_condensatori_con_dielettrici}
\include{18_introduzione_FEM}
\include{19_pdetool_solutore_laplace}
\include{20_esercitazioni}
\include{21_conduzione_stazionaria}
\include{22_dai_campi_ai_modelli}
\include{23_analisi_termica_conduttori}
\include{24_conduzione_FEM_resistenza}
\include{25_magnetostatica_correnti_stazionarie}
\include{26_spira_biot-savart_dipolo_magnetico}
\include{27_auto_mutua_induzione_bilanci_energetici_accoppiamenti_cavo_coassiale}
\include{28__induttanze_magnetismo_materiali}
\include{28_bis_materiali_magnetici_isteresi_perdite}
\include{29_riluttanza_circuiti_magnetici}
\include{30_circuiti_magnetici_non_lineari_metodo_tangenti}
\include{31_magneti_permanenti}
\include{32_circuito_magnetico_modelli_quasi_stazionari}
\include{33_conduttori_massicci_correnti_parassite}
\include{34_diffusione_campo_magnetico_bilanci_energia_poynting}
\include{35_forza_magnetica_macchina_elettrica}
